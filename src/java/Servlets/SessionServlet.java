    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (opcion) {
            ...
            case "ses":
                ...
                if (usr != null) {
                    String nombre = String.format("%s %s", usr.getNombre().trim(), usr.getApellido().trim());
                    String infoUser = String.format("{\"getNombres\":\"%s\",\"getNombreUsuario\":\"%s\",\"getCargo\":\"%s\"}", nombre, usr.getNombre_usuario(), usr.getCargo());
                    if (usr.getCargo().equals("tienda")) {
